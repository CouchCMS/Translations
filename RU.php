<?php
    ...
    // 2.0
    $t['left'] = 'Переместить влево';
    $t['right'] = 'Переместить вправо';
    $t['crop'] = 'Обрезать';
    ...
    $t['confirm_delete_tiles'] = 'Вы уверены, что хотите навсегда удалить отсутствующие плитки?';
    $t['add_above'] = 'Добавить Сверху';
    $t['confirm_delete_row'] = 'Удалить эту строку?';
    $t['no_data_message'] = '- Нет Данных -';
    $t['ok'] = 'OK';
    $t['globals'] = 'Глобальные Переменные';
    $t['manage_globals'] = 'Управление Глобальными Переменными';
    $t['bulk_action_with_selected'] = 'Групповые действия с выбранным';
    $t['month01'] = 'Январь';
    $t['month02'] = 'Февраль';
    $t['month03'] = 'Март';
    $t['month04'] = 'Апрель';
